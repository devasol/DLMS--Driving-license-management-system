    ...
    if (!type || type === 'pages') {
      const staticContent = [
        ...
        },
        {
          ...
          path: '/services',
          icon: '🚗',
          keywords: ['services', 'license', 'application', 'road', 'test', 'renewal', 'driving']
        },
        {
          type: 'page',
          title: 'About',
          ...
          path: '/about',
          icon: 'ℹ️',
          keywords: ['about', 'information', 'system', 'management', 'driving', 'license']
        },
        {
          type: 'page',
          title: 'Contact',
          ...
          path: '/contact',
          icon: '📞',
          keywords: ['contact', 'support', 'help', 'inquiries', 'phone', 'email']
        },
        {
          type: 'page',
          title: 'User Manual',
          ...
          path: '/user-manual',
          icon: '📖',
          keywords: ['manual', 'guide', 'help', 'instructions', 'tutorial', 'how to']
        },
        {
          type: 'service',
          ...
          path: '/services',
          icon: '🆔',
          keywords: ['license', 'application', 'apply', 'driving', 'online', 'new']
        },
        {
          type: 'service',
          title: 'Road Test',
          ...
          path: '/services',
          icon: '🛣️',
          keywords: ['road', 'test', 'driving', 'schedule', 'exam', 'practical']
        },
        {
          type: 'service',
          ...
          path: '/services',
          icon: '🔄',
          keywords: ['renewal', 'renew', 'license', 'existing', 'extend', 'update']
        },
        {
          type: 'service',
          ...
          path: '/services',
          icon: '✅',
          keywords: ['verification', 'verify', 'authentic', 'qr', 'code', 'check']
        }
      ];
