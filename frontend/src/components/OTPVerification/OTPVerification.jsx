...
const OTPVerification = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await axios.post("/api/auth/users/verify-otp", {
        email: userEmail,
        otp: otp,
      });
      ...
      if (
        error.response?.data?.type === "invalid_otp" &&
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await axios.post("/api/auth/users/resend-otp", {
        email: userEmail,
      });
