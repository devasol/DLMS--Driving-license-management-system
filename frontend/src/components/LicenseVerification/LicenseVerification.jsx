  ...
  const verifyLicense = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:5004/api/license/verify/${licenseNumber}`
      );
  ...
  return (
    ...
    >
      <Container maxWidth="lg">
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    ...
                    <Chip
                      ...
                      label={license.isExpired ? 'EXPIRED' : license.status.toUpperCase()}
                  ...
                  <Grid item xs={12} md={3}>
                    <Box sx={{ textAlign: 'center' }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {holder.hasPhoto ? 'Official Photo' : 'No Photo Available'}
                      </Typography>
                    </Box>
                  </Grid>
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                <Alert severity="success" sx={{ mt: 2 }}>
                  <Typography variant="body2">
                    <strong>✅ Verification Complete:</strong> This license has been successfully verified 
                    against the official Ethiopian Driving License Management System database. 
                    All information displayed is authentic and up-to-date.
                  </Typography>
                </Alert>
              </CardContent>
            </Card>
        ...
        >
          <Typography variant="body2" color="text.secondary">
            © 2025 Ethiopian Driving License Management System | 
            Powered by Government Digital Services
          </Typography>
          <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: 'block' }}>
            For official inquiries, contact the relevant transport authority office.
          </Typography>
        </Paper>
      </Container>
    </Box>
